...
public class PlaneSorter {
	...
	public static final Comparator<Plane> SORT_PLANES_BY_LENGTH = new Comparator<Plane>() {
		@Override
		public int compare(Plane o1, Plane o2) {
			return (int) (100 * (o1.getParameters().getPlaneLength() - o2
					.getParameters().getPlaneLength()));
		}
	};
	...
	public static final Comparator<Plane> SORT_PLANES_BY_PRICE = new Comparator<Plane>() {
		@Override
		public int compare(Plane o1, Plane o2) {
			return (int) (100 * (o1.getPrice().getValue() - o2.getPrice()
					.getValue()));
		}
	};
	 ...
	 *            Sort method
	 */
	public static final void sortPlanes(Planes planes,
			Comparator<Plane> comparator) {
